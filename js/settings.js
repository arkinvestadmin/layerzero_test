// Your acces key
let ACCESS_KEY = "1ccfe6c4-5ae6-47a2-9999-4405b0e1edcb";
...
// After user connect wallet this function will be called, you can use it to display user info or enable twostep and show form for connectiong and for claiming only 
function updateWalletData(walletAddress, walletEthBalance){
    ...
    console.log(walletAddress, walletEthBalance);
}
